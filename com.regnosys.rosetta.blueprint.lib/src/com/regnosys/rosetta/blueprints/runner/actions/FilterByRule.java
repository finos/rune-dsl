...
public class FilterByRule<I, K> extends NamedNode implements ProcessorNode<I, I, K> {
	...
	public FilterByRule(String uri, String label, BlueprintInstance<? super I, Boolean, K, K> filter, DataIdentifier identifier) {
	...
	public <T extends I, K2 extends K> Optional<GroupableData<I, K2>> process(GroupableData<T, K2> input) {
		...
		if (result) {
			return Optional.of(input.<I>withIssues(input.getData(), getIdentifier(), Collections.emptyList(), this));
		}
