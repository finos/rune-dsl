...
public class RJavaFieldWithMeta extends JavaClass<RosettaModelObject> {
	...
	public RJavaFieldWithMeta(JavaType valueType, DottedPath namespace, JavaTypeUtil javaTypeUtil) {
