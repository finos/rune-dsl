...
public class RJavaReferenceWithMeta extends RJavaWithMetaValue {
	...
	public Collection<JavaPojoProperty> getOwnProperties() {
		return List.of(
				new JavaPojoProperty("value", null, DATA, "value", "value", valueType, null, null, false, List.of(), false),
				new JavaPojoProperty("globalReference", null, REFERENCE, "globalReference", "globalReference", javaTypeUtil.STRING, null, AttributeMeta.META, false, List.of(), false),
				new JavaPojoProperty("externalReference", "reference", EXTERNAL_REFERENCE, "externalReference", "externalReference", javaTypeUtil.STRING, null, AttributeMeta.META, false, List.of(), false),
				new JavaPojoProperty("reference", "address", null, "reference", "reference", javaTypeUtil.REFERENCE, null, null, false, List.of(), false)
			);
	}
}
