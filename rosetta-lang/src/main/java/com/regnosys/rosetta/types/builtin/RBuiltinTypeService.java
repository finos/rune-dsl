...
public class RBuiltinTypeService {
	...
	public final RMetaAnnotatedType BOOLEAN_WITH_NO_META = RMetaAnnotatedType.withEmptyMeta(BOOLEAN);
	public final RBasicType TIME = registerConstantType(new RBasicType("time", true));
	public final RMetaAnnotatedType TIME_WITH_NO_META = RMetaAnnotatedType.withEmptyMeta(TIME);
	public final RBasicType PATTERN = registerConstantType(new RBasicType("pattern", false));
	public final RMetaAnnotatedType PATTERN_WITH_NO_META = RMetaAnnotatedType.withEmptyMeta(PATTERN);
	public final RBasicType NOTHING = registerConstantType(new RBasicType("nothing", true));
	public final RMetaAnnotatedType NOTHING_WITH_NO_META = RMetaAnnotatedType.withEmptyMeta(NOTHING);
	public final RBasicType ANY = registerConstantType(new RBasicType("any", false));
	public final RMetaAnnotatedType ANY_WITH_NO_META = RMetaAnnotatedType.withEmptyMeta(ANY);
	...
	public final RMetaAnnotatedType UNCONSTRAINED_INT_WITH_NO_META = RMetaAnnotatedType.withEmptyMeta(UNCONSTRAINED_INT);
	...
	public final RMetaAnnotatedType UNCONSTRAINED_NUMBER_WITH_NO_META = RMetaAnnotatedType.withEmptyMeta(UNCONSTRAINED_NUMBER);
	public final RStringType UNCONSTRAINED_STRING = new RStringType(Optional.empty(), Optional.empty(), Optional.empty());
	public final RMetaAnnotatedType UNCONSTRAINED_STRING_WITH_NO_META = RMetaAnnotatedType.withEmptyMeta(UNCONSTRAINED_STRING);
	
	public final RDateType DATE = registerConstantType(new RDateType());
	public final RMetaAnnotatedType DATE_WITH_NO_META = RMetaAnnotatedType.withEmptyMeta(DATE);
	public final RDateTimeType DATE_TIME = registerConstantType(new RDateTimeType());
	public final RMetaAnnotatedType DATE_TIME_WITH_NO_META = RMetaAnnotatedType.withEmptyMeta(DATE_TIME);
	public final RZonedDateTimeType ZONED_DATE_TIME = registerConstantType(new RZonedDateTimeType());
	public final RMetaAnnotatedType ZONED_DATE_TIME_WITH_NO_META = RMetaAnnotatedType.withEmptyMeta(ZONED_DATE_TIME);
