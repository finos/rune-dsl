...
class MetaFieldGenerator {
	...
	def metaFields(RosettaJavaPackages packages, Collection<RosettaMetaType> utypes) {
		...
		// Do not generated getters and setters for reference - this functionality is covered by externalReference
		val filteredTypes = new ArrayList(utypes.filter[!it.name.equals("reference")].toList);
