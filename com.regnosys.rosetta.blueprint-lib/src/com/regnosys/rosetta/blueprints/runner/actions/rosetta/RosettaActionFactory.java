...
public interface RosettaActionFactory {
	...
	<R extends RosettaModelObject, K> ProcessorNode<String, R, K> newRosettaIngester(String uri, String label, Class<R> modelClass);
	
	<I extends RosettaModelObject, O, K > ProcessorNode<I, O, K> newRosettaSimpleMapper(String uri, String label, MappingGroup<I, O> mappings);
	...
	<I extends RosettaModelObject, K> ProcessorNode<I, I, K> newRosettaValidator(String uri, String label, Class<I> ingestionType);
	
	<I extends RosettaModelObject, K1, K2> GroupNode<I, K1, K2> newRosettaGrouper(String uri, String label, Function<I, Mapper<K2>> function);
	
	<I1 extends RosettaModelObject, I2 extends RosettaModelObject, K, FK> DataJoinNode<I1, I2, K> newRosettaDataJoin(String uri, String label, Function<I1, Mapper<FK>> keyFunc, Function<I2, Mapper<FK>> foreignFunc, Class<I1> class1, Class<I2> class2);

	<I extends RosettaModelObject, O, K> ProcessorNode<I, O, K> newRosettaCalculationMapper(String uri, String label, MappingGroup<I, O> mappings);

	<I, O, K> ProcessorNode<I, O, K> newRosettaReturn(String uri, String label, DataIdentifier id, Supplier<Mapper<O>> function);
	
	<I extends RosettaModelObject, O, K> ProcessorNode<I, O, K> newRosettaLookup(String uri, String label, DataIdentifier id, String lookupName);
