...
public class BlueprintBuilder<I,O, K1 extends Comparable<K1>, K2 extends Comparable<K2>> {
	...
	public static <I, O, K1 extends Comparable<K1>, K2 extends Comparable<K2>> BlueprintBuilder<I, O, K1, K2> startsWith(RosettaActionFactory actionFactory, Node<I, O, K1, K2> n) {
	...
	public static <O, K extends Comparable<K>> BlueprintBuilder<Void,O,K, K> startsWith(RosettaActionFactory actionFactory, SourceNode<O, K> sourceNode) {
	...
	public static <I, O, K extends Comparable<K>> BlueprintBuilder<I,O,K, K> startsWith(RosettaActionFactory actionFactory, ExpanderNode<I,O,K> expandNode) {
	...
	public static <I, K extends Comparable<K>, K2 extends Comparable<K2>> BlueprintBuilder<I,I,K, K2> startsWith(RosettaActionFactory actionFactory, GroupNode<I,K, K2> groupNode) {
		StreamGroup<I, K, K2> group = new StreamGroup<>(groupNode);
		return new BlueprintBuilder<>(actionFactory, of(group), of(group), of(), of());
	}
	
	public static <I, O, K extends Comparable<K>> BlueprintBuilder<I,O, K, K> startsWith(RosettaActionFactory actionFactory, ProcessorNode<I, O, K> processorNode) {
		StreamProcessor<I, O, K> group = new StreamProcessor<>(processorNode);
		return new BlueprintBuilder<>(actionFactory, of(group), of(group), of(), of());
	}
	
	public static <I1, I2, K extends Comparable<K>> BlueprintBuilder<Object, I1, K, K> startsWith(RosettaActionFactory actionFactory, DataJoinNode<I1, I2, K> joinNode) {
	...
	public static <I, O, K1 extends Comparable<K1>, K2 extends Comparable<K2>> BlueprintBuilder<I, O, K1, K2> startsWith(RosettaActionFactory actionFactory, 
	...
	public <K3 extends Comparable<K3>> BlueprintBuilder<I,O, K1, K3> then(GroupNode<O,K2,K3> groupNode) {
	...
	public <O2, K3 extends Comparable<K3>> BlueprintBuilder<I, O2, K1, K3> then(BlueprintBuilder<O, O2, K2, K3> bp2) {
	...
	public <O2, K3 extends Comparable<K3>> BlueprintBuilder<I, O2, K1, K3> then(BlueprintInstance<? super O, O2, K2, K3> bp2) {
	...
	@SafeVarargs
	public static <I, O, K1 extends Comparable<K1>, K2 extends Comparable<K2>> BlueprintBuilder<I, O, K1, K2> and(RosettaActionFactory actionFactory, BlueprintBuilder<I, ? extends O, K1, K2>... bps) {
	...
	@SafeVarargs
	public static <I,O,K1 extends Comparable<K1>, K2 extends Comparable<K2>> BlueprintBuilder<I, O, K1, K2> ifElse(RosettaActionFactory actionFactory, String uri, String label
	...
	public static <I extends RosettaModelObject, K1 extends Comparable<K1>> BlueprintInstance<I, Object, K1, K1> doSimpleMappings(RosettaActionFactory actionFactory, String uri, String label, Collection<MappingGroup<I, ?>> mappings){
	...
	public static <I extends RosettaModelObject, O, K1 extends Comparable<K1>> BlueprintInstance<I, O, K1, K1> doCalcMappings(RosettaActionFactory actionFactory, String uri, Collection<MappingGroup<I, ? extends O>> mappings){
		Collection<Downstream<? super I,K1>> heads = new ArrayList<>();
