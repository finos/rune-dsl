...
The Rune serialization format is the default for models written in the Rune DSL. For example, the [FINOS Common Domain Model (CDM)](https://www.finos.org/common-domain-model) adopts it as its default serialization format from CDM version 7 onwards.
