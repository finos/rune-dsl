...
## 2. Documenting a schema

A schema can carry an optional description, in angle brackets after the format, as any other model
element does:

```
schema fixml XML <"FIXML 5.0 SP2, as published by the FIX Trading Community.">
```

The description sits before any annotations:
...
## 3. Referencing a schema from a transform function
