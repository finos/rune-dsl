...
class ContentAssistTest extends AbstractRosettaLanguageServerTest {
	...
	def testInheritedAttributesCondition() {
		...
		testCompletion[
			...
			and -> and [[9, 14] .. [9, 14]]
			any -> any [[9, 14] .. [9, 14]]
			as-reference -> as-reference [[9, 14] .. [9, 14]]
	...
	def void testConditionAfterArrow() {
		...
		testCompletion[
			...
			any -> any [[7, 27] .. [7, 27]]
			as-reference -> as-reference [[7, 27] .. [7, 27]]
	...
	def void testConditionAfterArrow2() {
		...
		testCompletion[
			...
			and -> and [[6, 25] .. [6, 25]]
			any -> any [[6, 25] .. [6, 25]]
			as-reference -> as-reference [[6, 25] .. [6, 25]]
	...
	def void testAssignOutputEnumLiteral() {
		...
		testCompletion[
			...
			and -> and [[19, 2] .. [19, 2]]
			any -> any [[19, 2] .. [19, 2]]
			as-reference -> as-reference [[19, 2] .. [19, 2]]
