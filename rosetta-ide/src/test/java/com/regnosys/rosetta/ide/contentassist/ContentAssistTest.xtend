...
class ContentAssistTest extends AbstractRosettaLanguageServerTest {
	...
	def void testAssignOutputEnumLiteral() {
		...
		testCompletion[
			...
			all -> all [[19, 2] .. [19, 2]]
			and -> and [[19, 2] .. [19, 2]]
			annotation -> annotation [[19, 2] .. [19, 2]]
			any -> any [[19, 2] .. [19, 2]]
			as-key -> as-key [[19, 2] .. [19, 2]]
			assign-output -> assign-output [[19, 2] .. [19, 2]]
			basicType -> basicType [[19, 2] .. [19, 2]]
			body -> body [[19, 2] .. [19, 2]]
			calculationType -> calculationType [[19, 2] .. [19, 2]]
			contains -> contains [[19, 2] .. [19, 2]]
			corpus -> corpus [[19, 2] .. [19, 2]]
			count -> count [[19, 2] .. [19, 2]]
			disjoint -> disjoint [[19, 2] .. [19, 2]]
			distinct -> distinct [[19, 2] .. [19, 2]]
			eligibility -> eligibility [[19, 2] .. [19, 2]]
			...
			join -> join [[19, 2] .. [19, 2]]
			last -> last [[19, 2] .. [19, 2]]
			library -> library [[19, 2] .. [19, 2]]
			map -> map [[19, 2] .. [19, 2]]
			max -> max [[19, 2] .. [19, 2]]
			metaType -> metaType [[19, 2] .. [19, 2]]
			min -> min [[19, 2] .. [19, 2]]
			...
			or -> or [[19, 2] .. [19, 2]]
			post-condition -> post-condition [[19, 2] .. [19, 2]]
			qualifiedType -> qualifiedType [[19, 2] .. [19, 2]]
			recordType -> recordType [[19, 2] .. [19, 2]]
			reduce -> reduce [[19, 2] .. [19, 2]]
			report -> report [[19, 2] .. [19, 2]]
			reporting -> reporting [[19, 2] .. [19, 2]]
			required -> required [[19, 2] .. [19, 2]]
			reverse -> reverse [[19, 2] .. [19, 2]]
			segment -> segment [[19, 2] .. [19, 2]]
			set -> set [[19, 2] .. [19, 2]]
			single -> single [[19, 2] .. [19, 2]]
			sort -> sort [[19, 2] .. [19, 2]]
			sum -> sum [[19, 2] .. [19, 2]]
			synonym -> synonym [[19, 2] .. [19, 2]]
			True -> True [[19, 2] .. [19, 2]]
			type -> type [[19, 2] .. [19, 2]]
			( -> ( [[19, 2] .. [19, 2]]
			* -> * [[19, 2] .. [19, 2]]
