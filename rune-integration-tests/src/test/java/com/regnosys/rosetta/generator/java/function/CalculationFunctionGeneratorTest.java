...
public class CalculationFunctionGeneratorTest {
	...
	@Test
	void testSimpleTransDep() {
		Map<String, String> generatedCode = generatorTestHelper.generateCode("""
				type Period:
					frequency int (1..1)
				...
				func PeriodEnumFunc(in1: PeriodEnum -> MONTH ):
					...
					set out: i * 30.0
				""");
		String generated = generatedCode.get("com.rosetta.test.model.functions.PeriodEnumFunc");
	...
	@Test
	void testOnePlusOneGeneration() {
		functionGeneratorHelper.assertToGeneratedCalculation("""
				func Calc:
					inputs:
						one int (1..1)
					output: out int (1..1)
	...
	@Test
	void testSimpleCalculationGeneration() {
		functionGeneratorHelper.assertToGeneratedCalculation("""
				func Calc:
					[calculation]
					inputs:
	...
	void testDateTimeAdd() {
		Map<String, String> calculation = generatorTestHelper.generateCode("""
				type FuncIn:
					val1 date (1..1)
					val2 time (1..1)
				...
				""");
		String calcJava = calculation.get("com.rosetta.test.model.functions.Calc");
		String expected = """
			package com.rosetta.test.model.functions;
		...
		generatorTestHelper.compileToClasses(calculation);
	}
		...
		Map<String, String> calculation = generatorTestHelper.generateCode("""
				...
				func RTS_22_Fields :
					...
					set out -> tradingDateTime:
						tradeDate + tradeTime
				""");
		String calcJava = calculation.get("com.rosetta.test.model.functions.RTS_22_Fields");
		generatorTestHelper.compileToClasses(calculation);
		String expected = """
			package com.rosetta.test.model.functions;
	...
	@Test
	void testAsKeyGenerationMultiValue() {
		functionGeneratorHelper.assertToGeneratedCalculation("""
				type WithMeta:
					[metadata key]
	...
	@Test
	void shouldResolveFunctionDependencies() {
		functionGeneratorHelper.assertToGeneratedCalculation("""
				func Adder:
					output: res int (1..1)
					alias arg1 : AddOne( 1 )
	...
	@Test
	void shouldResolveExternalFunctionDependenciesWhenEnumCalculation() {
		Map<String, String> generatedCode = generatorTestHelper.generateCode("""
				type MathInput:
		...
		String generated = generatedCode.get("com.rosetta.test.model.functions.MathFunc");
		assertEquals("""
				package com.rosetta.test.model.functions;
	...
	@Test
	void shouldResolveFunctionDependenciesWhenReferencedInAlias() {
		functionGeneratorHelper.assertToGeneratedCalculation("""
				func Adder :
					inputs: arg1 int (1..1)
					output: res int (1..1)
