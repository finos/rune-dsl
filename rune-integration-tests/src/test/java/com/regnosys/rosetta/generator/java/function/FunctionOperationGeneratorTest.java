...
public class FunctionOperationGeneratorTest {
    ...
    void testSimpleTransDep() {
        var generatedCode = generatorTestHelper.generateCode("""
        type Period:
        	frequency int (1..1)
    ...
    void testOnePlusOneGeneration() {
        functionGeneratorHelper.assertToGeneratedFunctionWithOperations(
            """
            func Calc:
            	inputs:
            		one int (1..1)
    ...
    @Test
    void testSimpleFunctionWithOperationsGeneration() {
        functionGeneratorHelper.assertToGeneratedFunctionWithOperations(
            """
            func Calc:
            	[calculation]
    ...
    @Test
    void shouldResolveExternalFunctionDependenciesWhenEnumFunction() {
        var generatedCode = generatorTestHelper.generateCode("""
        type MathInput:
