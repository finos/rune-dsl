...
public class SchemaValidatorConfigReloadTest extends AbstractValidatorTest {
	...
	void schemaValidationSeesReloadedConfiguration() {
		...
		assertIssues(MODEL, """
				ERROR (null) 'Schema 'reloadedXmlSchema' is marked [externalConfig] but no external serialization configuration is configured for it' at 5:3, length 14, on AnnotationRef
				""");
