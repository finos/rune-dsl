...
public interface SpansSeveralLines extends RosettaModelObject {
	...
	class SpansSeveralLinesBuilderImpl implements SpansSeveralLines.SpansSeveralLinesBuilder {
		...
		@SuppressWarnings("unchecked")
		@Override
		public SpansSeveralLines.SpansSeveralLinesBuilder merge(RosettaModelObjectBuilder other, BuilderMerger merger) {
			SpansSeveralLines.SpansSeveralLinesBuilder o = (SpansSeveralLines.SpansSeveralLinesBuilder) other;
