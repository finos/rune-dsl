        ...
        return getComparisonResults(o)
            ...
            .map(res -> {
                if (!isNullOrEmpty(res.getError())) {
                    return failure("Simple", ValidationResult.ValidationType.TYPE_FORMAT, "Simple", path, "", res.getError());
                }
                return success("Simple", ValidationResult.ValidationType.TYPE_FORMAT, "Simple", path, "");
            })
            .collect(toList());
    }
