...
public abstract class Conversions implements RosettaFunction {
    ...
    protected abstract MapperC<String> enums(String s, Colour colour, Date d, LocalDateTime dt, ZonedDateTime zdt);
    ...
    public static class ConversionsDefault extends Conversions {
        ...
        @Override
        protected MapperC<String> enums(String s, Colour colour, Date d, LocalDateTime dt, ZonedDateTime zdt) {
