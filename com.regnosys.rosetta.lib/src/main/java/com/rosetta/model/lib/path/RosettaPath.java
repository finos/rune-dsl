...
public class RosettaPath {
    ...
    public static RosettaPath createPath(RosettaPath parent, RosettaPath.Element element) {
        return new RosettaPath(parent, element);
    }

    public static RosettaPath createPath(RosettaPath.Element element) {
    ...
    public List<String> allElementPaths() {
        return allElements().stream()
                .map(RosettaPath.Element::getPath)
