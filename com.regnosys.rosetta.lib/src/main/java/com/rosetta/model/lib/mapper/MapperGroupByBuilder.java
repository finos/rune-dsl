...
public interface MapperGroupByBuilder<T,G> extends MapperGroupBy<T,G>{
	 ...
	 */
	default <F> MapperGroupByBuilder<F,G> mapC(String name, Function<T, List<? extends F>> mappingFunc) {
	 ...
	 */
	<F> MapperGroupByBuilder<F,G> mapC(NamedFunction<T, List<? extends F>> mappingFunc);
